    	...
    	<div id="topdiv">
            ...
            <span style="float:right">
       			...
       			<c:if test="${not empty user}">
       				...
       				<li>|</li>
       				<a href="userservlet?method=logOut" onclick="return confirm('确定要删除吗?')" id="a_top">退出</a>
       				<li>|</li>
...
<div id="second">
       ...
       <form action="goodsservlet?method=getGoodsListByTypeId" method="post" class="form-inline pull-right" style="margin-top: 40px;margin-right: 10px;">
		  ...
		  <div class="form-group">
		    <input  type="text" name="goodsName" value="${goodsName}" class="form-control" style="width: 400px"  placeholder="搜索一下好东西...">
		  </div>
